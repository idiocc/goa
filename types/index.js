 ...
 * @prop {function(string|Object, string|Array<string>=): void} set Set header `field` to `val`, or pass an object of header fields. _Examples_:
      - `this.set('Foo', ['bar', 'baz'])`
      - `this.set('Accept', 'application/json')`
      - `this.set({ Accept: 'text/plain', 'X-API-Key': 'tobi' })`.
 * @prop {function(string, string|Array<string>): void} append Append additional header `field` with value `val`. _Examples_:
 ...
 * @prop {string} type Return the response mime type void of parameters such as "charset". Set Content-Type response header with `type` through `mime.lookup()` when it does not contain a charset. _Examples_:
      ...
      - `this.type = 'png'`
 * @prop {Date} lastModified Get the Last-Modified date in Date form, if it exists. Set the Last-Modified date using a string or a Date. _Examples_:
 ...
 */
/**
 * @typedef {ContextDelegatedResponse & _goa.$BaseResponse} _goa.BaseResponse `@interface` The additional API not available via Context.
 */
/**
 ...
 */
/**
 * @typedef {BaseResponse & _goa.$Response} _goa.Response `@interface` The response object.
 */
/**
