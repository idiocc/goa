...
(a.length=Buffer.byteLength(d));b.end(d)}};const tc=new sc;async function uc(a){a.body="hello world";a.set("agc","def")}module.exports=uc;tc.use(uc);tc.listen(3001,()=>{console.log("http://localhost:3001")});
