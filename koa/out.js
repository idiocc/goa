...
Ua.test(a))c["filename*"]=a;if(e||f)c.filename=f?d:a}else c=void 0;return $a(new ab(b,c))}function $a({parameters:a,type:b}){if("string"!=typeof b||!Ya.test(b))throw new TypeError("invalid type");b=`${b}`.toLowerCase();if(a&&"object"==typeof a){let c;const d=Object.keys(a).sort();for(let e=0;e<d.length;e++){c=d[e];const f="*"==c.substr(-1)?"UTF-8''"+encodeURIComponent(String(a[c])).replace(Ta,bb):'"'+String(a[c]).replace(Wa,"\\$1")+'"';b+="; "+c+"="+f}}return b}
function bb(a){return"%"+String(a).charCodeAt(0).toString(16).toUpperCase()}class ab{constructor(a,b){this.type=a;this.parameters=b}};/*
 MIT
 Author dead_horse <dead_horse@qq.com>
 https://github.com/node-modules/error-inject
*/
function cb(a,b){if(a instanceof D&&!a.listeners("error").includes(b))a.on("error",b)};/*
 MIT
...
*/
function db(a,b,c){a.cache.set(b,c);a.a++;a.a>=a.max&&(a.a=0,a.i=a.cache,a.cache=new Map)}
class eb{constructor(a){this.max=a;this.a=0;this.cache=new Map;this.i=new Map}get(a,b={}){function c(){return e=e||Date.now()}let d=this.cache.get(a);b=b.maxAge;let e;if(d)return d.j&&c()>d.j?(d.j=0,d.value=void 0):void 0!==b&&(a=b?c()+b:0,d.j=a),d.value;if(d=this.i.get(a))return d.j&&c()>d.j?(d.j=0,d.value=void 0):(db(this,a,d),void 0!==b&&(a=b?c()+b:0,d.j=a)),d.value}set(a,b,c={}){c=(c=c.maxAge)?Date.now()+c:0;let d=this.cache.get(a);d?(d.j=c,d.value=b):(d={value:b,j:c},db(this,a,d))}keys(){function a(d){const e=
d[0],f=d[1];(d[1].value&&!d[1].j||f.j>=c)&&b.add(e)}const b=new Set,c=Date.now();for(const d of this.cache.entries())a(d);for(const d of this.i.entries())a(d);return Array.from(b.keys())}}const fb=new eb(100);/*
 MIT
 Jonathan Ong
 https://npmjs.org/koa-is-json
*/
function gb(a){return!a||"string"==typeof a||"function"==typeof a.pipe||Buffer.isBuffer(a)?!1:!0};/*
 escape-html
 ...
 MIT Licensed
*/
var hb=/["'&<>]/;const ib=_crypto.createHmac;function jb(a,b,c,d){return ib(b,c).update(a).digest(d).replace(/\/|\+|=/g,e=>({"/":"_","+":"-","=":""})[e])};function kb(a,b){if(null==a&&null!=b||null==b&&null!=a)return!1;if(null==a&&null==b)return!0;if(a.length!=b.length)return!1;for(var c=0,d=0;d<a.length;d++)c|=a.charCodeAt(d)^b.charCodeAt(d);return 0===c};/*
 keygrip
 Copyright(c) 2011-2014 Jed Schmidt
 MIT Licensed
*/
class lb{constructor(a,b="sha1",c="base64"){if(!(a&&0 in a))throw Error("Keys must be provided.");this.a=b;this.encoding=c;this.keys=a}sign(a){return jb(a,this.a,this.keys[0],this.encoding)}verify(a,b){return-1<this.index(a,b)}index(a,b){for(let c=0,d=this.keys.length;c<d;c++){const e=jb(a,this.a,this.keys[c],this.encoding);if(kb(b,e))return c}return-1}};const Q=/^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,mb=/^(?:lax|strict)$/i;function nb(a){var b=a.toString();a.maxAge&&(a.expires=new Date(Date.now()+a.maxAge));a.path&&(b+="; path="+a.path);a.expires&&(b+="; expires="+a.expires.toUTCString());a.domain&&(b+="; domain="+a.domain);a.sameSite&&(b+="; samesite=",b=!0===a.sameSite?b+"strict":b+a.sameSite.toLowerCase());a.secure&&(b+="; secure");a.httpOnly&&(b+="; httponly");return b}
class ob{constructor(a,b,c){this.path="/";this.maxAge=this.domain=this.expires=void 0;this.httpOnly=!0;this.overwrite=this.secure=this.sameSite=!1;if(!Q.test(a))throw new TypeError("argument name is invalid");if(b&&!Q.test(b))throw new TypeError("argument value is invalid");b||(this.expires=new Date(0));this.name=a;this.value=b||"";for(let d in c)this[d]=c[d];if(this.path&&!Q.test(this.path))throw new TypeError("option path is invalid");if(this.domain&&!Q.test(this.domain))throw new TypeError("option domain is invalid");
if(this.sameSite&&!0!==this.sameSite&&!mb.test(this.sameSite))throw new TypeError("option sameSite is invalid");}toString(){return this.name+"="+this.value}};/*
 cookies
...
*/
const R={};
class pb{constructor(a,b,c){this.secure=void 0;this.request=a;this.a=b;c&&(this.keys=Array.isArray(c.keys)?new lb(c.keys):c.keys,this.secure=c.secure)}get(a,b){const c=`${a}.sig`;var d;const e=b&&void 0!==b.signed?b.signed:!!this.keys;if(d=this.request.headers.cookie)if(d=d.match(R[a]?R[a]:R[a]=new RegExp("(?:^|;) *"+a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")+"=([^;]*)"))){d=d[1];if(!b||!e)return d;if(b=this.get(c)){a=a+"="+d;if(!this.keys)throw Error(".keys required for signed cookies");b=this.keys.index(a,
b);if(0>b)this.set(c,null,{path:"/",signed:!1});else return b&&this.set(c,this.keys.sign(a),{signed:!1}),d}}}set(a,b,c={}){const d=this.a;var e=this.request;let f=d.getHeader("Set-Cookie")||[];"string"==typeof f&&(f=[f]);var g=e.protocol;e=e.connection.encrypted;g=void 0!==this.secure?!!this.secure:"https"==g||e;const {signed:k=!!this.keys,...h}=c;a=new ob(a,b,h);if(!g&&c.secure)throw Error("Cannot send secure cookie over unencrypted connection");a.secure=g;"secure"in c||(a.secure=g);qb(f,a);if(c&&
k){if(!this.keys)throw Error(".keys required for signed cookies");a.value=this.keys.sign(a.toString());a.name+=".sig";qb(f,a)}(d.set?sa.prototype.setHeader:d.setHeader).call(d,"Set-Cookie",f);return this}}function qb(a,b){if(b.overwrite)for(var c=a.length-1;0<=c;c--)0===a[c].indexOf(b.name+"=")&&a.splice(c,1);a.push(nb(b))};const rb=/^\s*([^\s;]+)\s*(?:;(.*))?$/;function sb(a){return a.split(",").map((b,c)=>{var d=rb.exec(b.trim());if(d){b=d[1];var e=1;if(d[2]){d=d[2].split(";");for(let f=0;f<d.length;f++){const g=d[f].trim().split("=");if("q"==g[0]){e=parseFloat(g[1]);break}}}c={charset:b,q:e,h:c}}else c=null;if(c)return c}).filter(Boolean)}
function tb(a,b){const c=sb(void 0===a?"*":a||"");if(!b)return c.filter(ub).sort(vb).map(wb);const d=b.map((e,f)=>{{let k={c:-1,q:0,g:0};for(let h=0;h<c.length;h++){a:{var g=c[h];let l=0;if(g.charset.toLowerCase()===e.toLowerCase())l|=1;else if("*"!=g.charset){g=null;break a}g={h:f,g:l,c:g.h,q:g.q}}g&&0>(k.g-g.g||k.q-g.q||k.c-g.c)&&(k=g)}e=k}return e});return d.filter(ub).sort(vb).map(e=>b[d.indexOf(e)])}function vb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}
function wb(a){return a.charset}function ub(a){return 0<a.q};const xb=/^\s*([^\s;]+)\s*(?:;(.*))?$/;function yb(a){a=a.split(",");for(var b=!1,c=1,d=0,e=0;d<a.length;d++){var f=d;var g=xb.exec(a[d].trim());if(g){var k=g[1],h=1;if(g[2]){g=g[2].split(";");for(var l=0;l<g.length;l++){var n=g[l].trim().split("=");if("q"==n[0]){h=parseFloat(n[1]);break}}}f={encoding:k,q:h,h:f}}else f=null;f&&(a[e++]=f,b=b||zb("identity",f,void 0),c=Math.min(c,f.q||1))}b||(a[e++]={encoding:"identity",q:c,h:d});a.length=e;return a}
function zb(a,b,c){var d=0;if(b.encoding.toLowerCase()===a.toLowerCase())d|=1;else if("*"!==b.encoding)return null;return{h:c,c:b.h,q:b.q,g:d}}function Ab(a,b){var c=yb(a||"");if(!b)return c.filter(Bb).sort(Cb).map(Db);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},k=0;k<c.length;k++){var h=zb(e,c[k],f);h&&0>(g.g-h.g||g.q-h.q||g.c-h.c)&&(g=h)}return g});return d.filter(Bb).sort(Cb).map(function(e){return b[d.indexOf(e)]})}function Cb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}
function Db(a){return a.encoding}function Bb(a){return 0<a.q};const Eb=/^\s*([^\s\-;]+)(?:-([^\s;]+))?\s*(?:;(.*))?$/;function Fb(a){a=a.split(",");for(var b=0,c=0;b<a.length;b++){var d=Gb(a[b].trim(),b);d&&(a[c++]=d)}a.length=c;return a}function Gb(a,b){var c=Eb.exec(a);if(!c)return null;a=c[1];var d=c[2],e=a;d&&(e+="-"+d);var f=1;if(c[3]){c=c[3].split(";");for(var g=0;g<c.length;g++){var k=c[g].split("=");"q"==k[0]&&(f=parseFloat(k[1]))}}return{prefix:a,H:d,q:f,h:b,m:e}}
function Hb(a,b){var c=Fb(void 0===a?"*":a||"");if(!b)return c.filter(Ib).sort(Jb).map(Kb);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},k=0;k<c.length;k++){a:{var h=c[k];var l=f,n=Gb(e,void 0);if(n){var t=0;if(h.m.toLowerCase()===n.m.toLowerCase())t|=4;else if(h.prefix.toLowerCase()===n.m.toLowerCase())t|=2;else if(h.m.toLowerCase()===n.prefix.toLowerCase())t|=1;else if("*"!==h.m){h=null;break a}h={h:l,c:h.h,q:h.q,g:t}}else h=null}h&&0>(g.g-h.g||g.q-h.q||g.c-h.c)&&(g=h)}return g});return d.filter(Ib).sort(Jb).map(function(e){return b[d.indexOf(e)]})}
function Jb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}function Kb(a){return a.m}function Ib(a){return 0<a.q};const Lb=/^\s*([^s/;]+)\/([^;\s]+)\s*(?:;(.*))?$/;function Mb(a){a=a.split(",");for(var b=1,c=0;b<a.length;b++)0==Nb(a[c])%2?a[++c]=a[b]:a[c]+=","+a[b];a.length=c+1;for(c=b=0;b<a.length;b++){var d=Ob(a[b].trim(),b);d&&(a[c++]=d)}a.length=c;return a}
function Ob(a,b){var c=Lb.exec(a);if(!c)return null;a=Object.create(null);var d=1,e=c[2],f=c[1];if(c[3]){c=c[3].split(";");for(var g=1,k=0;g<c.length;g++)0==Nb(c[k])%2?c[++k]=c[g]:c[k]+=";"+c[g];c.length=k+1;for(g=0;g<c.length;g++)c[g]=c[g].trim();c=c.map(Pb);for(g=0;g<c.length;g++){var h=c[g];k=h[0].toLowerCase();h=(h=h[1])&&'"'===h[0]&&'"'===h[h.length-1]?h.substr(1,h.length-2):h;if("q"===k){d=parseFloat(h);break}a[k]=h}}return{type:f,v:e,u:a,q:d,h:b}}
function Qb(a,b,c){var d=Ob(a,void 0);a=0;if(!d)return null;if(b.type.toLowerCase()==d.type.toLowerCase())a|=4;else if("*"!=b.type)return null;if(b.v.toLowerCase()==d.v.toLowerCase())a|=2;else if("*"!=b.v)return null;var e=Object.keys(b.u);if(0<e.length)if(e.every(function(f){return"*"==b.u[f]||(b.u[f]||"").toLowerCase()==(d.u[f]||"").toLowerCase()}))a|=1;else return null;return{h:c,c:b.h,q:b.q,g:a}}
function Rb(a,b){var c=Mb(void 0===a?"*/*":a||"");if(!b)return c.filter(Sb).sort(Tb).map(Ub);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},k=0;k<c.length;k++){var h=Qb(e,c[k],f);h&&0>(g.g-h.g||g.q-h.q||g.c-h.c)&&(g=h)}return g});return d.filter(Sb).sort(Tb).map(function(e){return b[d.indexOf(e)]})}function Tb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}function Ub(a){return a.type+"/"+a.v}function Sb(a){return 0<a.q}
function Nb(a){for(var b=0,c=0;-1!==(c=a.indexOf('"',c));)b++,c++;return b}function Pb(a){var b=a.indexOf("=");if(-1===b)var c=a;else{c=a.substr(0,b);var d=a.substr(b+1)}return[c,d]};/*
 MIT
...
*/
class Vb{constructor(a){this.request=a;this.headers=this.request.headers}charset(a){return(a=this.charsets(a))&&a[0]}charsets(a){return tb(this.headers["accept-charset"],a)}encoding(a){return(a=this.encodings(a))&&a[0]}encodings(a){return Ab(this.headers["accept-encoding"],a)}language(a){return(a=this.languages(a))&&a[0]}languages(a){return Hb(this.headers["accept-language"],a)}mediaType(a){return(a=this.mediaTypes(a))&&a[0]}mediaTypes(a){return Rb(this.headers.accept,a)}};/*
 MIT
 Copyright(c) 2014 Jonathan Ong
 Copyright(c) 2015 Douglas Christopher Wilson
 https://npmjs.org/accepts
*/
class Wb{constructor(a){this.headers=a.headers;this.a=new Vb(a)}types(a,...b){a&&!Array.isArray(a)&&(a=[a,...b]);if(!a||0==a.length)return this.a.mediaTypes();if(!this.headers.accept)return a[0];b=a.map(Xb);var c=this.a.mediaTypes(b.filter(Yb));[c]=c;return c?a[b.indexOf(c)]:!1}get type(){return this.types}encodings(a,...b){a&&!Array.isArray(a)&&(a=[a,...b]);return a&&0!=a.length?this.a.encodings(a)[0]||!1:this.a.encodings()}get encoding(){return this.encodings}charsets(a,...b){a&&!Array.isArray(a)&&
(a=[a,...b]);return a&&0!=a.length?this.a.charsets(a)[0]||!1:this.a.charsets()}get charset(){return this.charsets}languages(a,...b){a&&!Array.isArray(a)&&(a=[a,...b]);return a&&0!=a.length?this.a.languages(a)[0]||!1:this.a.languages()}get lang(){return this.languages}get langs(){return this.languages}get language(){return this.languages}}function Xb(a){return-1==a.indexOf("/")?P(a):a}function Yb(a){return"string"==typeof a};/*
 http-errors
 Copyright(c) 2014 Jonathan Ong
 Copyright(c) 2016 Douglas Christopher Wilson
 MIT Licensed
...
(400>d||600<=d))d=500;a=S[d]||S[Number(String(d).charAt(0)+"00")];b||(b=a?new a(c):Error(c||J[d]),Error.captureStackTrace(b,S));a&&b instanceof a&&b.status===d||(b.expose=500>d,b.status=b.statusCode=d);for(let f in e)"status"!=f&&"statusCode"!=f&&(b[f]=e[f]);return b}class Zb extends Error{constructor(a){super();this.message=a;this.statusCode=this.status=null;this.expose=!1;this.headers=null}set code(a){this.statusCode=this.status=a;this.message||(this.message=J[a])}}
wa.forEach(a=>{let b;const c=$b(J[a]),d=c.match(/Error$/)?c:c+"Error";switch(Number(String(a).charAt(0)+"00")){case 400:b=class extends Zb{constructor(e){super(e);this.code=a;this.name=d;this.expose=!0}};break;case 500:b=class extends Zb{constructor(e){super(e);this.code=a;this.name=d;this.expose=!1}}}b&&(S[a]=b,S[c]=b)},{});function $b(a){return a.split(" ").map(function(b){return b.charAt(0).toUpperCase()+b.slice(1)}).join("").replace(/[^ _0-9a-z]/gi,"")};/*
 MIT Copyright (c) 2015 TJ Holowaychuk <tj@vision-media.ca>
 https://npmjs.org/delegates
*/
function T(a,b){const c=a.a,d=a.target;a.l.push(b);c.__defineGetter__(b,function(){return this[d][b]});return a}function ac(a,b){var c=a.a,d=a.target;a.C.push(b);c.__defineSetter__(b,function(e){return this[d][b]=e});return a}class bc{constructor(a,b){this.a=a;this.target=b;this.i=[];this.l=[];this.C=[]}method(a){const b=this.a,c=this.target;this.i.push(a);b[a]=function(){return this[c][a].apply(this[c],arguments)};return this}access(a){return ac(T(this,a),a)}};/*
 MIT jshttp/http-assert
*/
function cc(a,b,c,d){if(!a)throw S(b,c,d);};const dc=url.URL,U=url.Url,ec=url.format,fc=url.parse;const gc=net.isIP;const hc=querystring.parse,ic=querystring.stringify;/*
 parseurl
 Copyright(c) 2014 Jonathan Ong
 Copyright(c) 2014-2017 Douglas Christopher Wilson
 MIT Licensed
*/
function V(a){var b=a.url;if(void 0!==b){var c=a._parsedUrl;if("object"===typeof c&&null!==c&&(void 0===U||c instanceof U)&&c._raw===b)return c;a:if("string"!==typeof b||47!==b.charCodeAt(0))c=fc(b);else{c=b;for(var d=null,e=null,f=1;f<b.length;f++)switch(b.charCodeAt(f)){case 63:null===e&&(c=b.substring(0,f),d=b.substring(f+1),e=b.substring(f));break;case 9:case 10:case 12:case 13:case 32:case 35:case 160:case 65279:c=fc(b);break a}f=void 0!==U?new U:{};f.path=b;f.href=b;f.pathname=c;null!==e&&(f.query=
...
a}get subdomains(){const a=this.app.subdomainOffset,b=this.hostname;return gc(b)?[]:b.split(".").reverse().slice(a)}get accept(){return this.i||(this.i=new Wb(this.req))}set accept(a){this.i=a}accepts(a,...b){return this.accept.types(a,...b)}acceptsEncodings(a,...b){return this.accept.encodings(a,...b)}acceptsCharsets(a,...b){return this.accept.charsets(a,...b)}acceptsLanguages(a,...b){return this.accept.languages(a,...b)}is(a,...b){if(!a)return Sa(this.req);Array.isArray(a)||(a=[a,...b]);return Sa(this.req,
...
*/
function oc(a){if(!Array.isArray(a))throw new TypeError("Middleware stack must be an array!");for(const b of a)if("function"!=typeof b)throw new TypeError("Middleware must be composed of functions!");return(b,c)=>{function d(f){if(f<=e)return Promise.reject(Error("next() called multiple times"));e=f;let g=a[f];f==a.length&&(g=c);if(!g)return Promise.resolve();try{return Promise.resolve(g(b,d.bind(null,f+1)))}catch(k){return Promise.reject(k)}}let e=-1;return d(0)}};var Z;Z=function(){const a=new na(y);return function(b){const c=ka(a);c.namespace=b;c.useColors=y.useColors();c.enabled=a.enabled(b);c.color=la(a,b);c.destroy=function(){a.destroy(this)};c.extend=function(d,e){d=this.namespace+(void 0===e?":":e)+d;d.log=this.log;return d};ma(a);return c}}()("@goa/koa:application");async function pc(a,b){const c=a.res;c.statusCode=404;L(c,d=>a.onerror(d));try{return await b(a),qc(a)}catch(d){a.onerror(d)}}
class rc extends ua{constructor(){super();this.silent=this.proxy=!1;this.middleware=[];this.subdomainOffset=2;this.env=process.env.NODE_ENV||"development";this.context=Object.create(Y.prototype);this.request=Object.create(mc.prototype);this.response=Object.create(nc.prototype);this.keys=void 0}[p.custom](){return this.inspect()}listen(...a){Z("listen");return ta(this.callback()).listen(...a)}toJSON(){return{subdomainOffset:this.subdomainOffset,proxy:this.proxy,env:this.env}}inspect(){return this.toJSON()}use(a){if("function"!=
typeof a)throw new TypeError("middleware must be a function!");if("function"!=typeof a?0:qa.test(pa.call(a))||(z?A(a)==ra:"[object GeneratorFunction]"==oa.call(a)))throw Error("Generator functions are not supported by @goa/koa. Use koa-convert on them first.");Z("use %s",a.D||a.name||"-");this.middleware.push(a);return this}callback(){const a=oc(this.middleware);if(!this.listenerCount("error"))this.on("error",this.onerror);return(b,c)=>{b=this.createContext(b,c);return pc(b,a)}}createContext(a,b){const c=
...
function qc(a){if(0!=a.respond&&a.writable){var b=a.res,c=a.status,d=a.body;if(I[c])return a.body=null,b.end();if("HEAD"==a.method)return!b.headersSent&&gb(d)&&(a.length=Buffer.byteLength(JSON.stringify(d))),b.end();if(null==d)return d=2<=a.req.httpVersionMajor?String(c):a.message||String(c),b.headersSent||(a.type="text",a.length=Buffer.byteLength(d)),b.end(d);if(Buffer.isBuffer(d))return b.end(d);if("string"==typeof d)return b.end(d);if(d instanceof D)return d.pipe(b);d=JSON.stringify(d);b.headersSent||
(a.length=Buffer.byteLength(d));b.end(d)}};const sc=new rc;async function tc(a){a.body="hello world";a.set("agc","def")}module.exports=tc;sc.use(tc);sc.listen(3001,()=>{console.log("http://localhost:3001")});
