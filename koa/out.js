...
" ")},O:function(a){return p(a,{...this.inspectOpts,colors:this.useColors})},...ha}};function ia(a){function b(...g){if(b.enabled){var h=Number(new Date);b.diff=h-(f||h);b.prev=f;f=b.curr=h;g[0]=ja(g[0]);"string"!=typeof g[0]&&g.unshift("%O");var k=0;g[0]=g[0].replace(/%([a-zA-Z%]+)/g,(l,n)=>{if("%%"==l)return l;k++;if(n=c[n])l=n.call(b,g[k]),g.splice(k,1),k--;return l});d.call(b,g);(b.log||e).apply(b,g)}}const c=a.formatters,d=a.formatArgs,e=a.log;let f;return b}function ka(a){const b=ia(a);"function"==typeof a.init&&a.init(b);a.a.push(b);return b}
...
function J(a){if("number"==typeof a){if(!J[a])throw Error("invalid status code: "+a);return a}if("string"!=typeof a)throw new TypeError("code must be a number or string");var b=parseInt(a,10);if(!isNaN(b)){if(!J[b])throw Error("invalid status code: "+b);return b}b=J[a.toLowerCase()];if(!b)throw Error('invalid status message: "'+a+'"');return b};/*
 ...
 MIT Licensed
*/
function K(a,b){function c(){d();b.apply(null,arguments)}function d(){for(var x,M=0;M<f.length;M++)x=f[M],x.A.removeListener(x.event,x.B)}function e(x){b=x}if(!Array.isArray(a))throw new TypeError("arg must be an array of [ee, events...] arrays");for(var f=[],g=0;g<a.length;g++){var h=a[g];if(!Array.isArray(h)||2>h.length)throw new TypeError("each array member must be [ee, events...]");for(var k=h[0],l=1;l<h.length;l++){var n=h[l],t=ya(n,c);k.on(n,t);f.push({A:k,event:n,B:t})}}e.cancel=d;return e}
...
function Aa(a,b){function c(h){g.cancel();e.cancel();f=!0;b(h)}function d(h){a.removeListener("socket",d);f||g===e&&(e=K([[h,"error","close"]],c))}var e,f=!1;var g=e=K([[a,"end","finish"]],c);if(a.socket)d(a.socket);else a.on("socket",d)}function za(a){function b(c){a.__onFinished===b&&(a.__onFinished=null);if(b.s){var d=b.s;b.s=null;for(var e=0;e<d.length;e++)d[e](c,a)}}b.s=[];return b};const {ReadStream:Ba}=fs;/*
 MIT
 Copyright(c) 2014 Jonathan Ong
...
function Ja(){const a=["nginx","apache",void 0,"iana"];Object.keys(N).forEach(b=>{const c=N[b],d=c.extensions;if(d&&d.length){Ia[b]=d;for(let e=0;e<d.length;e++){const f=d[e];if(O[f]){const g=a.indexOf(N[O[f]].source),h=a.indexOf(c.source);if("application/octet-stream"!=O[f]&&(g>h||g==h&&"application/"==O[f].substr(0,12)))continue}O[f]=b}}})};/*
 MIT content-type
...
if(0>b)this.set(c,null,{path:"/",signed:!1});else return b&&this.set(c,this.keys.sign(a),{signed:!1}),d}}}set(a,b,c={}){const {a:d,request:e}=this;let f=d.getHeader("Set-Cookie")||[];"string"==typeof f&&(f=[f]);var g=e.protocol;const h=e.connection.encrypted;g=void 0!==this.secure?!!this.secure:"https"==g||h;const {signed:k=!!this.keys,...l}=c;a=new nb(a,b,l);if(!g&&c.secure)throw Error("Cannot send secure cookie over unencrypted connection");a.secure=g;"secure"in c||(a.secure=g);pb(f,a);if(c&&k){if(!this.keys)throw Error(".keys required for signed cookies");
...
function sb(a,b){const c=rb(void 0===a?"*":a||"");if(!b)return c.filter(tb).sort(ub).map(vb);const d=b.map((e,f)=>{{let h={c:-1,q:0,g:0};for(let k=0;k<c.length;k++){a:{var g=c[k];let l=0;if(g.charset.toLowerCase()===e.toLowerCase())l|=1;else if("*"!=g.charset){g=null;break a}g={h:f,g:l,c:g.h,q:g.q}}g&&0>(h.g-g.g||h.q-g.q||h.c-g.c)&&(h=g)}e=h}return e});return d.filter(tb).sort(ub).map(e=>b[d.indexOf(e)])}function ub(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}
function vb(a){return a.charset}function tb(a){return 0<a.q};const wb=/^\s*([^\s;]+)\s*(?:;(.*))?$/;function xb(a){a=a.split(",");for(var b=!1,c=1,d=0,e=0;d<a.length;d++){var f=d;var g=wb.exec(a[d].trim());if(g){var h=g[1],k=1;if(g[2]){g=g[2].split(";");for(var l=0;l<g.length;l++){var n=g[l].trim().split("=");if("q"==n[0]){k=parseFloat(n[1]);break}}}f={encoding:h,q:k,h:f}}else f=null;f&&(a[e++]=f,b=b||yb("identity",f,void 0),c=Math.min(c,f.q||1))}b||(a[e++]={encoding:"identity",q:c,h:d});a.length=e;return a}
function yb(a,b,c){var d=0;if(b.encoding.toLowerCase()===a.toLowerCase())d|=1;else if("*"!==b.encoding)return null;return{h:c,c:b.h,q:b.q,g:d}}function zb(a,b){var c=xb(a||"");if(!b)return c.filter(Ab).sort(Bb).map(Cb);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},h=0;h<c.length;h++){var k=yb(e,c[h],f);k&&0>(g.g-k.g||g.q-k.q||g.c-k.c)&&(g=k)}return g});return d.filter(Ab).sort(Bb).map(function(e){return b[d.indexOf(e)]})}function Bb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}
function Cb(a){return a.encoding}function Ab(a){return 0<a.q};const Db=/^\s*([^\s\-;]+)(?:-([^\s;]+))?\s*(?:;(.*))?$/;function Eb(a){a=a.split(",");for(var b=0,c=0;b<a.length;b++){var d=Fb(a[b].trim(),b);d&&(a[c++]=d)}a.length=c;return a}function Fb(a,b){var c=Db.exec(a);if(!c)return null;a=c[1];var d=c[2],e=a;d&&(e+="-"+d);var f=1;if(c[3]){c=c[3].split(";");for(var g=0;g<c.length;g++){var h=c[g].split("=");"q"==h[0]&&(f=parseFloat(h[1]))}}return{prefix:a,H:d,q:f,h:b,m:e}}
function Gb(a,b){var c=Eb(void 0===a?"*":a||"");if(!b)return c.filter(Hb).sort(Ib).map(Jb);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},h=0;h<c.length;h++){a:{var k=c[h];var l=f,n=Fb(e,void 0);if(n){var t=0;if(k.m.toLowerCase()===n.m.toLowerCase())t|=4;else if(k.prefix.toLowerCase()===n.m.toLowerCase())t|=2;else if(k.m.toLowerCase()===n.prefix.toLowerCase())t|=1;else if("*"!==k.m){k=null;break a}k={h:l,c:k.h,q:k.q,g:t}}else k=null}k&&0>(g.g-k.g||g.q-k.q||g.c-k.c)&&(g=k)}return g});return d.filter(Hb).sort(Ib).map(function(e){return b[d.indexOf(e)]})}
...
function Nb(a,b){var c=Kb.exec(a);if(!c)return null;a=Object.create(null);var d=1,e=c[2],f=c[1];if(c[3]){c=c[3].split(";");for(var g=1,h=0;g<c.length;g++)0==Mb(c[h])%2?c[++h]=c[g]:c[h]+=";"+c[g];c.length=h+1;for(g=0;g<c.length;g++)c[g]=c[g].trim();c=c.map(Ob);for(g=0;g<c.length;g++){var k=c[g];h=k[0].toLowerCase();k=(k=k[1])&&'"'===k[0]&&'"'===k[k.length-1]?k.substr(1,k.length-2):k;if("q"===h){d=parseFloat(k);break}a[h]=k}}return{type:f,v:e,u:a,q:d,h:b}}
...
function Qb(a,b){var c=Lb(void 0===a?"*/*":a||"");if(!b)return c.filter(Rb).sort(Sb).map(Tb);var d=b.map(function(e,f){for(var g={c:-1,q:0,g:0},h=0;h<c.length;h++){var k=Pb(e,c[h],f);k&&0>(g.g-k.g||g.q-k.q||g.c-k.c)&&(g=k)}return g});return d.filter(Rb).sort(Sb).map(function(e){return b[d.indexOf(e)]})}function Sb(a,b){return b.q-a.q||b.g-a.g||a.c-b.c||a.h-b.h||0}function Tb(a){return a.type+"/"+a.v}function Rb(a){return 0<a.q}
...
(a=[a,...b]);return a&&0!=a.length?this.a.charsets(a)[0]||!1:this.a.charsets()}get charset(){return this.charsets}languages(a,...b){a&&!Array.isArray(a)&&(a=[a,...b]);return a&&0!=a.length?this.a.languages(a)[0]||!1:this.a.languages()}get lang(){return this.languages}get langs(){return this.languages}get language(){return this.languages}}function Wb(a){return-1==a.indexOf("/")?P(a):a}function Xb(a){return"string"==typeof a};/*
 ...
 MIT Licensed
*/
function S(...a){let b=500,c={};for(var d=0;d<a.length;d++){var e=a[d];if(e instanceof Error){var f=e;b=f.status||f.statusCode||b}else switch(typeof e){case "string":var g=e;break;case "number":b=e;0!==d&&process.emitWarning("non-first-argument status code; replace with createError("+e+", ...)","DeprecationWarning");break;case "object":c=e}}"number"==typeof b&&(400>b||600<=b)&&process.emitWarning("non-error status code; use only 4xx or 5xx status codes","DeprecationWarning");if("number"!=typeof b||
!J[b]&&(400>b||600<=b))b=500;a=S[b]||S[Number(String(b).charAt(0)+"00")];f||(f=a?new a(g):Error(g||J[b]),Error.captureStackTrace(f,S));a&&f instanceof a&&f.status===b||(f.expose=500>b,f.status=f.statusCode=b);for(let h in c)"status"!=h&&"statusCode"!=h&&(f[h]=c[h]);return f}class Yb extends Error{constructor(a){super();this.message=a;this.statusCode=this.status=null}set code(a){this.statusCode=this.status=a;this.message||(this.message=J[a])}}
...
*/
var ic=/(?:^|,)\s*?no-cache\s*?(?:,|$)/;
function jc(a,b){var c=a["if-modified-since"],d=a["if-none-match"];if(!c&&!d||(a=a["cache-control"])&&ic.test(a))return!1;if(d&&"*"!==d){a=b.etag;if(!a)return!1;for(var e=!0,f=0,g=[],h=0,k=0,l=d.length;k<l;k++)switch(d.charCodeAt(k)){case 32:h===f&&(h=f=k+1);break;case 44:g.push(d.substring(h,f));h=f=k+1;break;default:f=k+1}g.push(d.substring(h,f));for(d=0;d<g.length;d++)if(f=g[d],f===a||f==="W/"+a||"W/"+f===a){e=!1;break}if(e)return!1}return!c||(b=b["last-modified"],b&&kc(b)<=kc(c))?!0:!1}
...
a||(2<=this.req.httpVersionMajor&&(a=this.get(":authority")),a||(a=this.get("Host")));return a?a.split(/\s*,\s*/,1)[0]:""}get hostname(){const a=this.host;return a?"["==a[0]?this.URL.hostname||"":a.split(":",1)[0]:""}get URL(){if(!this.a){const a=this.protocol,b=this.host,c=this.originalUrl||"";try{this.a=new cc(`${a}://${b}${c}`)}catch(d){this.a=Object.create(null)}}return this.a}get fresh(){const a=this.method,b=this.ctx.status;return"GET"!=a&&"HEAD"!=a?!1:200<=b&&300>b||304==b?jc(this.header,this.response.header):
!1}get stale(){return!this.fresh}get idempotent(){return"GET HEAD PUT DELETE OPTIONS TRACE".split(" ").includes(this.method)}get socket(){return this.req.socket}get charset(){try{const {parameters:a}=Na(this.req);return a.charset||""}catch(a){return""}}get length(){const a=this.get("Content-Length");return""==a?null:~~a}get protocol(){if(this.socket.encrypted)return"https";if(!this.app.proxy)return"http";const a=this.get("X-Forwarded-Proto");return a?a.split(/\s*,\s*/,1)[0]:"http"}get secure(){return"https"==
this.protocol}get ips(){const {proxy:a}=this.app,b=this.get("X-Forwarded-For");return a&&b?b.split(/\s*,\s*/):[]}get ip(){this[W]||(this[W]=this.ips[0]||this.socket.remoteAddress||"");return this[W]}set ip(a){this[W]=a}get subdomains(){const a=this.app.subdomainOffset,b=this.hostname;return fc(b)?[]:b.split(".").reverse().slice(a)}get accept(){return this.i||(this.i=new Vb(this.req))}set accept(a){this.i=a}accepts(a,...b){return this.accept.types(a,...b)}acceptsEncodings(a,...b){return this.accept.encodings(a,
...b)}acceptsCharsets(a,...b){return this.accept.charsets(a,...b)}acceptsLanguages(a,...b){return this.accept.languages(a,...b)}is(a,...b){if(!a)return Sa(this.req);Array.isArray(a)||(a=[a,...b]);return Sa(this.req,a)}get type(){const a=this.get("Content-Type");return a?a.split(";")[0]:""}get(a){const b=this.req;switch(a=a.toLowerCase()){case "referer":case "referrer":return b.headers.referrer||b.headers.referer||"";default:return b.headers[a]||""}}inspect(){if(this.req)return this.toJSON()}toJSON(){return{method:this.method,
url:this.url,header:this.header}}[p.custom](){return this.inspect()}};const X=Symbol("context#cookies");
